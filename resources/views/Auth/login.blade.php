...
<head>
    ...
    <title>@yield('page-title','Iso One - Login')</title>
                                ...
                                <div class="card-body p-4 p-lg-5 text-black">
                                    ...
                                    <form action="{{ route('verifyLogin') }}" method="post">
                                        ...
                                        <div class="d-flex align-items-center mb-3 pb-1">
                                            ...
                                            <span class="h1 fw-bold mb-0">Iso One</span>
                                        </div>
                                        ...
                                        <p class="mb-5 pb-lg-2" style="color: #393f81;">¿No tienes una cuenta? <a href="#!" style="color: #393f81;">Registrar aquí</a></p>
