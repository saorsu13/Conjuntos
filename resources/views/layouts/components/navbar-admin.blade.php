    ...
    <div class="container-fluid">
        ...
        <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
            ...
            <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <li class="nav-item">
                    <div class="btn-group">
                        <button type="button" class="btn btn-secondary btn-xs ">Mensajes</button>
                        <button type="button" class="btn btn-secondary dropdown-toggle dropdown-toggle-split" data-bs-toggle="dropdown" aria-expanded="false">
                            <span class="visually-hidden">Toggle Dropdown</span>
                        </button>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="javascript:void(0);">Nuevo Mensaje</a></li>
                            <li><a class="dropdown-item" href="javascript:void(0);">Bandeja de Entrada</a></li>
                            <li><a class="dropdown-item" href="javascript:void(0);">Enviados</a></li>
                            <li><a class="dropdown-item" href="javascript:void(0);">Basurero</a></li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="javascript:void(0);">Importar Usuarios</a></li>
                            <li><a class="dropdown-item" href="javascript:void(0);">Listados</a></li>
                            <li>
                                <hr class="dropdown-divider" />
                            </li>
