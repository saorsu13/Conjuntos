<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <li class="menu-header small text-uppercase"><span class="menu-header-text">Conjuntos de Edificios</span></li>
        <li class="menu-item">
    ...
    <li class="menu-header small text-uppercase"><span class="menu-header-text">Conjuntos de Casas</span></li>
    <li class="menu-item">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon fas fa-tachometer-alt-average"></i>
