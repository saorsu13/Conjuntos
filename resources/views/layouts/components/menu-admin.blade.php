    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Planificacion">Planificacion</div>
            </a>
            <ul class="menu-sub">
                <li class="menu-item active">
                    <a href="{{ route('home')}}" class="menu-link">
        ...
        <li class="menu-item">
            ...
            <li class="menu-item">
                ...
                <li class="menu-item">
                    <a href="javascript:void(0);" class="menu-link menu-toggle">
                        <div data-i18n="Administrar">Administrar</div>
                    </a>
                    <ul class="menu-sub">
                        <li class="menu-item">
                ...
                <li class="menu-item">
                    ...
                    <ul class="menu-sub">
                        <li class="menu-item">
                            <a href="layouts-collapsed-menu.html" class="menu-link">
                                <div data-i18n="Personalizacion">Personalizacion</div>
                            </a>
                        </li>
                        <li class="menu-item">
                            <a href="layouts-collapsed-menu.html" class="menu-link">
                        ...
                        <li class="menu-item">
                            <a href="layouts-collapsed-menu.html" class="menu-link">
                                <div data-i18n="Responsables">Responsables</div>
                            </a>
                        </li>
                        <li class="menu-item">
                            <a href="layouts-collapsed-menu.html" class="menu-link">
                                <div data-i18n="Campos">Campos</div>
                            </a>
                        </li>
                        <li class="menu-item">
                            <a href="layouts-collapsed-menu.html" class="menu-link">
                                <div data-i18n="Permisos Documento">Permisos Documento</div>
                            </a>
                        </li>
                        <li class="menu-item">
                            <a href="layouts-collapsed-menu.html" class="menu-link">
                                <div data-i18n="Permisos Usuario">Permisos Usuario</div>
                            </a>
                        </li>
                        <li class="menu-item">
                            <a href="layouts-collapsed-menu.html" class="menu-link">
                                <div data-i18n="Codigos">Codigos</div>
                            </a>
                        </li>
                        <li class="menu-item">
                            <a href="layouts-collapsed-menu.html" class="menu-link">
                                <div data-i18n="Plantillas">Plantillas</div>
                            </a>
                        </li>
                        <li class="menu-item">
                            <a href="layouts-collapsed-menu.html" class="menu-link">
                                <div data-i18n="Validez">Validez</div>
                            </a>
                        </li>
                    </ul>
                </li>
        ...
        <li class="menu-item">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon fas fa-sort-amount-down"></i>
