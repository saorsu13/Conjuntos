...
<div class="col-12">
    <div class="card">
        <h5 class="card-header">Editar Cargo</h5>
        <div class="card-body">
            <div class="row">
                ...
                <form action="{{ route('actualizarCargo',['id' => $cargo->cargo_id]) }}" method="POST" class="form-horizontal" role="form" id="bootstrap">
                    ...
                    <div class="col-sm-6" style="margin-top: 10px;">
                        ...
                        <input name="nombre" type="text" class="form-control" id="defaultFormControlInput" placeholder="{{$cargo -> nombre}}" aria-describedby="defaultFormControlHelp" />
                    </div>
                    <div class="col-sm-6" style="margin-top: 10px;">
                    ...
                    <a class="btn btn-danger" style="margin-top: 15px;" href="{{ route('indexCargo')}}">Cancelar</a>
                </form>
            </div>
        </div>
    </div>
